...
\years{2017.01-\\2017.11}{\bf Research Intern. Megvii (Face++) Inc.}\hfill 
\mbox{Advisor: Dr.~\href{https://zsc.github.io/}{Shuchang Zhou}}

{\bf $\blacktriangleright$ Face Attributes Transfiguration}\quad I  proposed a cross-domain image translation method named GeneGAN to achieve generate multi-modal images of a certain attribute. I participated most of experiments using our proprietary MegDL framework, and reproduce them using TensorFlow. This paper was accepted by BMVC 2017 as an oral presentation.
