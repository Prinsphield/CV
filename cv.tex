...
\item Research Assistant, UC Merced, Aug. 2018 - present \hfill Advisor: \href{http://faculty.ucmerced.edu/mhyang/}{Ming-Hsuan Yang}\\
	$\bullet$ Visual Privacy Preserving\\
	$\bullet$ Learning Correspondence from Images and Videos
	
\item Research Intern, \href{https://research.google}{Google Cloud}, Sunnyvale, May, 2022 - Dec, 2022 \hfill Host: \href{http://llcao.net/}{Liangliang Cao} \\
	$\bullet$ Few-shot Finetuning Large Vision-Language Models
...
\item Research Intern, \href{https://research.google}{Google Research}, Mountain View, May, 2021 - April, 2022 \hfill Host: \href{https://andrefaraujo.github.io/}{Andre Araujo} \\
	$\bullet$ Keypoint Detector and Feature Descriptor for Instance Matching
...
\item FlowNAS: Neural Architecture Search for Optical Flow Estimation \\
	Tingting Liang$^*$, Zhiwei Lin$^*$, {\bf Taihong Xiao}$^*$, Yongtao Wang, Zhi Tang, Ming-Hsuan Yang \\
	{\it Under Review, 2022} \\
...
\item Learning Contrastive Representation for Semantic Correspondence \\
	...
	\href{https://trebuchet.public.springernature.app/get_content/93a4184a-fda0-4930-892e-515331427254}{[Paper]}
...
\item Conference Reviewer, CVPR, ICCV, ECCV, NeurIPS, AAAI, AISTATS, WACV, BMVC, AVSS

\item Journal Reviewer, TIP, TCVST, TETCI
